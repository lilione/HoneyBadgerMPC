...
if __name__ == '__main__':
    del_file('./time_hand_off_item.log')
    del_file('./time_source_item.log')
    ...
    for i in range(2):
        for j in range(1, 3):
            log_file = f"./log_calc_share_peer{i}_org{j}.txt"
            del_file(log_file)
            log_file = f"./log_source_item_peer{i}_org{j}.txt"
            del_file(log_file)
            log_file = f"./log_hand_off_item_peer{i}_org{j}.txt"
            del_file(log_file)
